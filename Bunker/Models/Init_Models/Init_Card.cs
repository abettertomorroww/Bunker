...
namespace Bunker.Models.Init_Models
{
    class Init_Card
    {
        ...
        private void Fill_Card()
        {
            ...
            specifications.Card.Add("Все узнают местонaхoждение маленького тайника с продовольствием");
            specifications.Card.Add("Добавить 1 место в бункер (Нельзя применить, если карта уже применялась в игре)");
            specifications.Card.Add("Все узнают, что рядом находится погреб с вином");
            specifications.Card.Add("Перебросить голос 'Против' с одного любого игрока на другого игрока");
            specifications.Card.Add("Вы можете раскрыть фобию любого человека");
            specifications.Card.Add("Все узнают, что рядом есть склад инструментов");
            specifications.Card.Add("Все узнают местонaхoждение большого тайника с продовольствием");
            specifications.Card.Add("Вы можете раскрыть характеристику здоровья у любого человека");
            specifications.Card.Add("Вы можете раскрыть характеристику фобии у любого человека");
            specifications.Card.Add("Вы можете раскрыть характеристику хобби у любого человека");
            specifications.Card.Add("Вы можете раскрыть характеристику професси у любого человека");
            specifications.Card.Add("Вы можете раскрыть характеристику роста и веса у любого человека");
            specifications.Card.Add("Все узнают, что рядом есть электростанция");
            specifications.Card.Add("Дает вам ммунитет на 1 круг (Нельзя применить, если осталось 6 или меньше людей)");
            specifications.Card.Add("Все узнают, что поблизости находится военный склад с оружием(состояние - неизвестно");
            specifications.Card.Add("Все узнают, что недалеко расположено поле, где может находится рогатый скот");
            specifications.Card.Add("Убрать 1 место из бункера (Нельзя применить, если карта уже применялась в игре)");
            specifications.Card.Add("Все узнают, что поблизости расположена неразграбленная автомастерская с множеством инструментов, материалов и деталей");
        }
    }
}
